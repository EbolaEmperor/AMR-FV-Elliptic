...
if (DEFINED CLANG_FORMAT) 
  message(STATUS "Setting format targets")
    file (GLOB_RECURSE ALL_CC_FILES  src/*.cpp test/*.cpp example/*.cpp UnitTest/*.cpp)
    file (GLOB_RECURSE ALL_HH_FILES  src/*.h test/*.h example/*.h UnitTest/*.h)
